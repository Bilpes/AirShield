#!/usr/bin/env python3
"""Build the AirShield requirements/runbook and CEO technical briefing PDFs."""
...
class Cover(Flowable):
    ...
    def draw(self):
        ...
        c.setFont("AirSans", 7)
        c.drawString(left, 16 * mm, "Version 1.0  •  23 August 2026  •  Internal hackathon build")
...
class Diagram(Flowable):
    def __init__(self, kind: str):
        super().__init__()
        self.kind = kind
        self.height = {"architecture": 99, "voice": 86, "vault": 84}[kind] * mm
