...
export const NAV_META = {
  overview: ["AI privacy operations", "Overview"], live: ["Real-time protection", "Live Shield"], egress: ["Release control", "EgressSeal™"],
  lab: ["Validation", "Performance Lab"], trustlab: ["Agent trust layer", "Agent Trust Lab"],
  policies: ["Governance", "Policy Studio"],
