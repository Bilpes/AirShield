...
import { EgressSealCenter } from "./views/EgressSealCenter";
...
import { AgentTrustLab } from "./views/AgentTrustLab";
...
export function AirShieldApp() {
  ...
  return <>
    <AppShell view={view} setView={setView} sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen}>
      ...
      {view === "egress" && <EgressSealCenter notify={setToast}/>}
      ...
      {view === "trustlab" && <AgentTrustLab notify={setToast}/>}
