...
import { Activity, Bell, Beaker, Blocks, ChevronDown, FileClock, Grid2X2, KeyRound, Menu, Mic2, PlugZap, Search, Settings, ShieldCheck, SlidersHorizontal, X } from "lucide-react";
  ...
  return <div className="app-shell">
    ...
    <section className="main-column">
      ...
      <nav className="mobile-nav" aria-label="Mobile navigation">{[
        {id:"overview" as ViewId,label:"Home",icon:Grid2X2},{id:"live" as ViewId,label:"Shield",icon:Mic2},{id:"policies" as ViewId,label:"Policies",icon:SlidersHorizontal},{id:"audit" as ViewId,label:"Audit",icon:FileClock}
